...
CREATE TABLE `cestabasica` (
  `cestaBasica_id` int NOT NULL AUTO_INCREMENT,
  `dataRetirada` date DEFAULT NULL,
  `descricaoItens` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`cestaBasica_id`)
...
INSERT INTO `cestabasica` VALUES (1,'2023-07-31','Arroz, Feijão, Macarrão, Bolacha, Detergente, Leite, Margarina, Chá Mate, Óleo, Ovos, Farofa tradicional, Molho de Tomate, Macarrão, Café, Pão de forma'),(2,'2024-10-01','Arroz, feijão, Macarrão, óleo, sal, açúcar, bolacha, manteiga, ovos, molho de tomate');
