...
--
-- Table structure for table `composicaofamiliar`
--

DROP TABLE IF EXISTS `composicaofamiliar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `composicaofamiliar` (
  `composicaoFamiliar_id` int NOT NULL AUTO_INCREMENT,
  `contemplado_id` int DEFAULT NULL,
  `morador_id` int DEFAULT NULL,
  PRIMARY KEY (`composicaoFamiliar_id`),
  KEY `contemplado_idFKFamilia` (`contemplado_id`),
  KEY `morador_idFK` (`morador_id`),
...
--
-- Dumping data for table `composicaofamiliar`
--

LOCK TABLES `composicaofamiliar` WRITE;
/*!40000 ALTER TABLE `composicaofamiliar` DISABLE KEYS */;
INSERT INTO `composicaofamiliar` VALUES (1,1,1),(2,1,2),(3,7,3);
/*!40000 ALTER TABLE `composicaofamiliar` ENABLE KEYS */;
UNLOCK TABLES;
